...
const Premium = () => {
  ...
  // If user is already premium, show "already a member" card
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4 flex items-center justify-center">
        <div className="max-w-md w-full text-center">
          ...
          <span
            className={`inline-block px-6 py-2 rounded-full text-white font-semibold text-lg my-4 ${
              isGold
          ...
          <p className="text-gray-500 mb-8">
            You already have an active {isGold ? "Gold" : "Silver"} premium
            membership. Enjoy all the exclusive features!
          </p>
          <Link
            to="/feed"
